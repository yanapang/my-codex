...
Usage:
  ...
  omx tmux-hook Manage team/legacy tmux prompt injection workaround (init|status|validate|test)
  omx hooks     Manage OMX hook plugins (init|status|validate|test)
