...
Usage:
  ...
  omx tmux-hook Manage team/legacy tmux prompt injection workflow (init|status|validate|test)
  omx hooks     Manage native hook plugins (init|status|validate|test)
