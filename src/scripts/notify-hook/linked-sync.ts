...
export async function syncLinkedRalphOnTeamTerminalInDir(stateDir: any, nowIso: any): Promise<void> {
...
export async function syncLinkedRalphOnTeamTerminal(stateRootDir: any, nowIso: any, payloadSessionId: any): Promise<void> {
