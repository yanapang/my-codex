...
- Las sesiones no-team ahora son native-hook-first.
- `omx tmux-hook` queda reservado para runtime de equipo y depuración tmux heredada.
- Los archivos de plugins se encuentran en `.omx/hooks/*.mjs`.
- Los plugins están activados por defecto; desactívalos con `OMX_HOOK_PLUGINS=0`.
